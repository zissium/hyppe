...
add_action('after_setup_theme', 'mixtape_qodef_admin_map_init', 0);

function mixtape_qodef_admin_map_init() {

    do_action('mixtape_qodef_before_options_map');
    ...
    do_action('mixtape_qodef_options_map');

    do_action('mixtape_qodef_after_options_map');
