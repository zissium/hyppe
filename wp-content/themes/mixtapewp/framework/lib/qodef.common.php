...
$mixtape_qodef_options_fontstyle = array( "normal" => esc_html__("normal", 'mixtapewp'),
 "italic" => esc_html__("italic", 'mixtapewp')
);
$mixtape_qodef_options_fontweight = array( "100" => "100",
 "200" => "200",
 "300" => "300",
 "400" => "400",
 "500" => "500",
...
$mixtape_qodef_options_texttransform = array( "none" => esc_html__("None", 'mixtapewp'),
 "capitalize" => esc_html__("Capitalize", 'mixtapewp'),
 "uppercase" => esc_html__("Uppercase", 'mixtapewp'),
 "lowercase" => esc_html__("Lowercase", 'mixtapewp')
);

$mixtape_qodef_options_fontdecoration = array( "none" => esc_html__("none", 'mixtapewp'),
 "underline" => esc_html__("underline", 'mixtapewp')
);

$mixtape_qodef_options_arrows_type = array(
...
$mixtape_qodef_options_double_arrows_type = array(
	'fa fa-angle-double-' => 'fa-angle-double',
	'arrow_carrot-2' => 'arrow_carrot-2',
	'arrow_carrot-2left_alt2' => 'arrow_carrot 2 alt2',
	'icon-arrows-left-double-32' => 'icon-arrows double',
...
$mixtape_qodef_options_arrows_up_type = array(
