...
if(!function_exists('mixtape_qodef_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function mixtape_qodef_get_wpml_pages_for_current_page() {
		$wpml_pages_for_current_page = array();

		if(mixtape_qodef_is_wpml_installed()) {
...
if(!function_exists('mixtape_qodef_disable_wpml_css')) {
    function mixtape_qodef_disable_wpml_css() {
	    define('ICL_DONT_LOAD_LANGUAGE_SELECTOR_CSS', true);
    }

	add_action('after_setup_theme', 'mixtape_qodef_disable_wpml_css');
}