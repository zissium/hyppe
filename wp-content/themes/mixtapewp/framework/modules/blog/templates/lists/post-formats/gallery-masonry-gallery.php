...
$image_gallery = get_post_meta($id, 'qodef_post_gallery_images_meta', true);
$gallery_urls = array();
if ($image_gallery != '') {
	...
	<?php if (!empty($gallery_urls)) { ?>
		<div class="qodef-blog-gallery qodef-owl-slider">
			...
			foreach ($gallery_urls as $pic_url): ?>
				<div class="qodef-blog-gallery-item" style="background-image:url('<?php echo esc_url($pic_url); ?>');">
