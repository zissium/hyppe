...
if ( ! function_exists( 'mixtape_qodef_subtitle_text' ) ) {
	...
	function mixtape_qodef_subtitle_text() {
		...
		print mixtape_qodef_get_module_part( $subtitle );
	}
}
...
if ( ! function_exists( 'mixtape_qodef_custom_breadcrumbs' ) ) {
	...
	function mixtape_qodef_custom_breadcrumbs() {
		...
		if ( is_home() && ! is_front_page() ) {
			...
			if ( $showOnHome == 1 ) {
				$output = '<div class="qodef-breadcrumbs"><div class="qodef-breadcrumbs-inner"><a ' . mixtape_qodef_get_inline_style( $bread_style ) . ' href="' . $homeLink . '">' . $home . '</a></div></div>';
			}
		} else {
