<?php
if ( ! function_exists( 'mixtape_qodef_init_google_fonts_array' ) ) {
	function mixtape_qodef_init_google_fonts_array() {

		global $mixtape_qodef_fonts_array;
		$mixtape_qodef_fonts_array =
			array(
				0   =>
					array(
				...
				357 =>
					array(
						...
						'files'        =>
							array(
								'regular' => 'http://fonts.gstatic.com/s/lqodefr/v4/G432jp-tahOfWHbCYkI0jw.ttf',
							),
					),
				358 =>
					array(
	...
	add_action('after_setup_theme', 'mixtape_qodef_init_google_fonts_array');
}