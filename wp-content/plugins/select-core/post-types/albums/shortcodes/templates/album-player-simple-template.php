<div class="qodef-audio-player-wrapper <?php echo esc_attr($player_classes) ?>" >
    ...
    <div id= "qodef-player-container-<?php echo esc_attr($player_id); ?>" class="qodef-audio-player-holder qodef-audio-player-simple " data-album-id="<?php echo esc_attr($album); ?>" <?php qodef_core_inline_style($player_styles); ?>>
