...
class MixtapeQodeSocialIconWidget extends MixtapeQodeWidget {
	...
	public function widget( $args, $instance ) {
        ...
        <a class="qodef-social-icon-widget-holder" <?php echo mixtape_qodef_get_inline_attr( $hover_color, 'data-hover-color' ); ?> <?php mixtape_qodef_inline_style( $social_icon_styles ) ?> href="<?php echo esc_attr( $link ); ?>" target="<?php echo esc_attr( $target ); ?>">
