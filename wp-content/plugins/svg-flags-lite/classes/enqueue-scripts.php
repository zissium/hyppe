...
class Enqueue_Scripts
{
    ...
    public function enqueue_admin_scripts( $hook )
    {
        ...
        wp_enqueue_script(
            'wpgo-all-admin-pages-fw-js',
            $all_admin_pages_js_url,
            array(),
            $all_admin_pages_js_ver,
            true
        );
    ...
    public function enqueue_admin_settings_scripts( $hook )
    {
        ...
        wp_enqueue_script(
            'wpgo-admin-settings-fw-js',
            $admin_settings_fw_js_url,
            array(),
            $admin_settings_fw_js_ver,
            true
        );
        // Styles for plugin admin settings page
        wp_enqueue_style(
            $this->enq_pfx . '-admin-settings-fw-css',
            $admin_settings_fw_css_url,
            [],
            $admin_settings_fw_css_ver
        );
        wp_enqueue_style(
