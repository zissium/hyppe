    ...
    public function try_our_other_plugins($current_plugin = "")
    {
      ...
      $plugins = [
        "flexible-faqs" => [
          ...
          "thumb" => $this->module_roots['uri'] . "/api/assets/images/flexible-faqs-thumb.png"
        ],
        "svg-flags" => [
          "label" => "SVG Flags",
          "link" => "https://wpgoplugins.com/plugins/svg-flags/",
          "thumb" => $this->module_roots['uri'] . "/api/assets/images/svg-flags-thumb.png"
        ],
        "simple-sitemap" => [
          "label" => "Simple Sitemap",
          "link" => "https://wpgoplugins.com/plugins/simple-sitemap/",
          "thumb" => $this->module_roots['uri'] . "/api/assets/images/simple-sitemap-thumb.png"
        ],
        "content-censor" => [
          "label" => "Content Censor",
          "link" => "https://wpgoplugins.com/plugins/content-censor/",
          "thumb" => $this->module_roots['uri'] . "/api/assets/images/content-censor-thumb.png"
        ],
        "seo-media-manager" => [
          "label" => "SEO Media Manager",
          "link" => "https://wpgoplugins.com/plugins/seo-media-manager/",
          "thumb" => $this->module_roots['uri'] . "/api/assets/images/seo-media-manager-thumb.png"
        ]
      ];
    ...
    public function keep_in_touch() {
      ...
      <td>
        <div><p style="margin-bottom:10px;">Come and say hello. I\'d love to hear from you!</p>
          <span><a class="social-link" href="http://www.twitter.com/dgwyer" title="Follow me on Twitter" target="_blank"><img src="' . $this->module_roots['uri'] . '/api/assets/images/twitter.png" /></a></span>
          <span><a class="social-link" href="https://www.facebook.com/wpgoplugins/" title="Our Facebook page" target="_blank"><img src="' . $this->module_roots['uri'] . '/api/assets/images/facebook.png" /></a></span>
          <span><a class="social-link" href="https://www.youtube.com/channel/UCWzjTLWoyMgtIfpDgJavrTg" title="View our YouTube channel" target="_blank"><img src="' . $this->module_roots['uri'] . '/api/assets/images/yt.png" /></a></span>
