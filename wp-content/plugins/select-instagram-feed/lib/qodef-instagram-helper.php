...
/**
 * Class QodefInstagramHelper
 */
class QodefInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines qodef_instagram_image_atts filter
    ...
    public function getImageHTML($image, $imageSize) {
        ...
        $imageAtts = apply_filters('qodef_instagram_image_atts',
            array(
                'class' => $imageSize,
